...
public sealed record TutorConversationInput(string Subject, string? Title = null);
public sealed record TutorMessageInput(string Content, string? Mode = "explicar");
