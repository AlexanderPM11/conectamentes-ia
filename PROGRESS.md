...
2026-09-16: Arquitectura de publicación ajustada para Dokploy: solo frontend publica puerto, API y MySQL quedan privados en `app_network`; Nginx proxifica `/api` y `/hubs` internamente, manteniendo login, chat SignalR y reuniones sin exponer el backend.
